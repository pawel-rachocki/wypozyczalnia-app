...
@Component({
  ...
  templateUrl: './samochod-form.component.html',
  styleUrl: './samochod-form.component.css'
})
export class SamochodFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.samochodForm = this.fb.group({
      marka: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]],
      model: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]],
      cenaZaDzien: ['', [Validators.required, Validators.min(0.01), Validators.max(10000)]],
